...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Roll to Defend Wiki',
    description: 'Copyright and intellectual property information for Roll to Defend Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Roll to Defend Wiki',
      description: 'Copyright and intellectual property information for Roll to Defend Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Roll to Defend Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Roll to Defend Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Roll to Defend Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox Corporation</strong> - Owner of the Roblox platform</li>
              <li><strong>Roll to Defend Developers</strong> - Creators of the Roll to Defend game (D:/Drive)</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>Unit names and abilities</li>
            ...
            <ul>
              ...
              <li><strong>Roll to Defend</strong> - Trademark of the game developers</li>
              <li><strong>Roll to Defend Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Roll to Defend Wiki.
            </p>
            ...
            <p>
              ...
              Roll to Defend Wiki<br />
              Email: <a href="mailto:dmca@rolltodefendwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@rolltodefendwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to &quot;Roll to Defend Wiki&quot;</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>&quot;Source: Roll to Defend Wiki (rolltodefendwiki.wiki)&quot;</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@rolltodefendwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@rolltodefendwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@rolltodefendwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@rolltodefendwiki.wiki</a>
            </p>
            <p>
